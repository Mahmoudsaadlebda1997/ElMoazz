...
<div id="loader" style="display:none;">
    <div
        style="display: flex;width: 100%;height: 100%;position: fixed;z-index: 9999;background: rgba(255,255,255,0.7);top: 0;left: 0;right: 0;bottom: 0;justify-content: center;align-items: center">
        <h2>LOADING ...</h2>
    </div>
</div>
<!--begin::Root-->
