        ...
        <div class="header-menu-wrapper header-menu-wrapper-left" id="kt_header_menu_wrapper">
            ...
            <div id="kt_header_menu" class="header-menu header-menu-mobile header-menu-layout-default">
                ...
                <ul class="menu-nav">
                    ...
                    {{--                                            <li class="menu-item" aria-haspopup="true">--}}
                    {{--                                                <a href="javascript:;" class="menu-link">--}}
                    {{--                                                    <i class="menu-bullet menu-bullet-dot"><span></span></i><span class="menu-text">Reached Users</span>--}}
                    {{--                                                </a>--}}
                    {{--                                            </li>--}}
                    {{--                                            <li class="menu-item" aria-haspopup="true">--}}
                    {{--                                                <a href="javascript:;" class="menu-link">--}}
                    {{--                                                    <i class="menu-bullet menu-bullet-dot"><span></span></i><span class="menu-text">SEO Ranking</span>--}}
                    {{--                                                </a>--}}
                    {{--                                            </li>--}}
                    {{--                                            <li class="menu-item" aria-haspopup="true">--}}
                    {{--                                                <a href="javascript:;" class="menu-link">--}}
                    {{--                                                    <i class="menu-bullet menu-bullet-dot"><span></span></i><span class="menu-text">User Dropout Points</span>--}}
                    {{--                                                </a>--}}
                    {{--                                            </li>--}}
                    {{--                                            <li class="menu-item" aria-haspopup="true">--}}
                    {{--                                                <a href="javascript:;" class="menu-link">--}}
                    {{--                                                    <i class="menu-bullet menu-bullet-dot"><span></span></i><span class="menu-text">Market Segments</span>--}}
                    {{--                                                </a>--}}
                    {{--                                            </li>--}}
                    {{--                                            <li class="menu-item" aria-haspopup="true">--}}
                    {{--                                                <a href="javascript:;" class="menu-link">--}}
                    {{--                                                    <i class="menu-bullet menu-bullet-dot"><span></span></i><span class="menu-text">Opportunity Growth</span>--}}
                    {{--                                                </a>--}}
                    {{--                                            </li>--}}
                    {{--                                        </ul>--}}
                    {{--                                    </div>--}}
                    ...
                    {{--                                            <li class="menu-item" aria-haspopup="true">--}}
                    {{--                                                <a href="javascript:;" class="menu-link">--}}
                    {{--                                                    <i class="menu-bullet menu-bullet-line"><span></span></i><span class="menu-text">Merge Branch</span><span class="menu-label"><span class="label label-danger label-rounded">3</span></span>--}}
                    {{--                                                </a>--}}
                    {{--                                            </li>--}}
                    {{--                                            <li class="menu-item" aria-haspopup="true">--}}
                    {{--                                                <a href="javascript:;" class="menu-link">--}}
                    {{--                                                    <i class="menu-bullet menu-bullet-line"><span></span></i><span class="menu-text">Version Controls</span>--}}
                    {{--                                                </a>--}}
                    {{--                                            </li>--}}
                    {{--                                            <li class="menu-item" aria-haspopup="true">--}}
                    {{--                                                <a href="javascript:;" class="menu-link">--}}
                    {{--                                                    <i class="menu-bullet menu-bullet-line"><span></span></i><span class="menu-text">Database Manager</span>--}}
                    {{--                                                </a>--}}
                    {{--                                            </li>--}}
                    {{--                                            <li class="menu-item" aria-haspopup="true">--}}
                    {{--                                                <a href="javascript:;" class="menu-link">--}}
                    {{--                                                    <i class="menu-bullet menu-bullet-line"><span></span></i><span class="menu-text">System Settings</span>--}}
                    {{--                                                </a>--}}
                    {{--                                            </li>--}}
                    {{--                                        </ul>--}}
                    {{--                                    </div>--}}
...
{{--                             data-mobile-height="200" style="height: 200px; overflow: auto;"></div>--}}
{{--                        <!--end::Scroll-->--}}
{{--                    </div>--}}
{{--                </div>--}}
{{--                <!--end::Dropdown-->--}}
...
{{--                                     data-mobile-height="200" style="height: 200px; overflow: auto;">--}}
{{--                                    <!--begin::Item-->--}}
...
{{--            <!--end::Quick panel-->--}}
            ...
            <div class="dropdown">
                ...
                <div class="topbar-item" data-toggle="dropdown" data-offset="10px,0px">
                    <div class="btn btn-icon btn-clean btn-dropdown btn-lg mr-1">
                        <img class="h-20px w-20px rounded-sm"
                             src="{{asset('public/metronic/img/'.app()->getLocale().'.svg')}}" alt=""/>
                    </div>
                </div>
                <!--end::Toggle-->
                ...
                <div class="dropdown-menu p-0 m-0 dropdown-menu-anim-up dropdown-menu-sm dropdown-menu-right">
                    ...
                    <ul class="navi navi-hover py-4">
                        <!--begin::Item-->
                        <li class="navi-item">
                            <a href="{{route('swapLanguage',['locale'=>'en'])}}" class="navi-link">
                                <span class="symbol symbol-20 mr-3">
                                    <img src="{{asset('public/metronic/img/en.svg')}}" alt=""/>
                                </span>
                        ...
                        <li class="navi-item active">
                            <a href="{{route('swapLanguage',['locale'=>'ar'])}}" class="navi-link">
                                <span class="symbol symbol-20 mr-3">
                                    <img src="{{asset('public/metronic/img/ar.svg')}}" alt=""/>
                                </span>
            ...
            <!--begin::User-->
            <div class="topbar-item">
                <a href="{{route('handleLogoutAdmin')}}" title="{{__('trans.logout')}}" class="btn btn-icon btn-icon-mobile w-auto btn-clean d-flex align-items-center btn-lg px-2"
                     id="kt_quick_user_toggle">
                    <span class="text-muted font-weight-bold font-size-base d-none d-md-inline mr-1">Hi,</span>
                    <span
                        class="text-dark-50 font-weight-bolder font-size-base d-none d-md-inline text-capitalize mr-3">{{auth()->user()->username ?? ''}}</span>
                    <span class="symbol symbol-lg-35 symbol-25 symbol-light-success">
                        <span
                            class="symbol-label font-size-h5 font-weight-bold text-capitalize">{{substr((auth()->user()->username ?? ''),0,1)}}</span>
                    </span>
                </a>
            </div>
            <!--end::User-->
